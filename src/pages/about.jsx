...
function About({ darkMode }) {
  ...
  return (
    <div
      className='lg:mx-12 mx-8 lg:my-36 my-24 flex flex-col lg:gap-8 gap-4 justify-start items-start overflow-auto'
      style={{ height: `${screenWidth < 1080 ? "100vh" : "85vh"}` }}
    >
      <div className='grid lg:grid-cols-2 lg:gap-10 w-full lg:h-full lg:mb-0 mb-72'>
        <div className='flex flex-col justify-center items-center lg:mt-0 mt-5 lg:mb-0 mb-2'>
          <div
            className='lg:w-120 lg:h-120 w-52 h-52 rounded-full waviy border-0 z-20'
            style={{
        ...
        <div className='flex flex-col justify-center items-start gap-2 lg:-ml-20 -ml-0 lg:mb-8 mb-0 w-full'>
          <div className='flex flex-col gap-2 w-full'>
            <h2
              className='lg:text-7xl text-4xl font-poppins dark:text-white fade-up-text mb-2 lg:-ml-1'
              style={{ animationDelay: screenWidth <= 1080 ? `0.3s` : `0s` }}
            >
            ...
            <p
              className='font-dmsans dark:text-white fade-up-text lg:w-11/12 w-full'
              style={{ animationDelay: screenWidth <= 1080 ? `0.4s` : `0.1s` }}
            >
              {window.location.hostname === "enricarmengol.com" ? (
                <Trans
                  ...
                  values={{
                    bold1ENG:
                      "Superior Grade in Web Application Development (DAW)",
                    bold1ESP:
                      "Grado Superior en Desarrollo de Aplicaciones Web (DAW)",
                    bold1CAT:
                      "Grau Superior de Desenvolupament d`Aplicacions Web (DAW)",
            ...
            <p
              className='font-dmsans dark:text-white fade-up-text lg:w-11/12 w-full'
              style={{ animationDelay: screenWidth <= 1080 ? `0.5s` : `0.2s` }}
            >
              {window.location.hostname === "enricarmengol.com" ? (
                <Trans
            ...
            <p
              className='font-dmsans dark:text-white fade-up-text lg:w-11/12 w-full'
              style={{ animationDelay: screenWidth <= 1080 ? `0.6s` : `0.3s` }}
            >
              {window.location.hostname === "enricarmengol.com" ? (
                t("aboutMe.part3")
              ) : (
                <Trans
                  ...
                  values={{
                    ...
                    bold8ENG:
                      "inspiration has gotta come from somewhere, right? ;p",
                    bold8ESP:
                      "la inspiración tiene que venir de algún sitio, no? ;p",
                    bold8CAT:
                      "la inspiració ha de venir d`alguna banda, no? ;p",
                  }}
                />
              )}
            </p>
            <p
              className='font-dmsans dark:text-white fade-up-text lg:w-11/12 w-full'
              style={{ animationDelay: screenWidth <= 1080 ? `0.7s` : `0.4s` }}
            >
              {window.location.hostname === "enricarmengol.com" ? (
                <Trans
          ...
          <div className='flex lg:flex-row flex-col gap-5 justify-between lg:w-11/12 w-full'>
            ...
            >
              {randomSong && (
                <>
                  <div
                    alt={`${randomSong.title} cover`}
                    className='w-16 h-16 rounded-full mr-4 music-spin relative'
                    style={{
                      backgroundImage: `url(${randomSong.cover})`,
                      backgroundSize: "cover",
                      backgroundPosition: "center",
                    }}
                  ></div>
                  <div>
                    <p className='text-sm text-black font-dmsans dark:text-gray-200'>
                      Recently played
                      <img
                        src={darkMode ? spotifyDark : spotifyLight}
                        alt='Spotify'
                        className='w-5 h-5 inline-block align-top ml-2'
                      />
                    </p>
                    <p className='text-lg font-dmsans font-semibold dark:text-white'>
                      {randomSong.title}
                    </p>
                    <p className='text-sm font-dmsans  font-semibold dark:text-gray-200'>
                      {randomSong.artist}
                    </p>
                  </div>
                </>
            ...
            <div
              className='flex gap-6 justify-center items-center mt-4 fade-up-text order-first lg:order-last'
              style={{ animationDelay: screenWidth <= 1080 ? `0.8s` : `0.6s` }}
            >
              <a
                href='https://github.com/kuwuro'
                target='_blank'
                rel='noreferrer'
              >
                {!darkMode ? (
                  <img
                    src={GithubLight}
                    alt='Github'
                    className='w-12 h-12 hover:scale-110 transition duration-200'
                  />
                ) : (
                  <img
                    src={GithubDark}
              ...
              {window.location.hostname === "enricarmengol.com" ? (
                <>
                  <a
                    href='https://www.linkedin.com/in/enric-armengol/'
                    target='_blank'
                    rel='noreferrer'
                  >
                    {!darkMode ? (
                  ...
                  <button onClick={downloadCV}>
                    {!darkMode ? (
                      <img
                        src={DownloadCVLight}
                        alt='Download CV'
                        className='w-11 h-11 hover:scale-110 transition duration-200'
                      />
                    ) : (
                      <img
                        src={DownloadCVDark}
                ...
                <>
                  <a
                    href='https://twitter.com/kurotekku'
                    target='_blank'
                    rel='noreferrer'
                  >
                    {!darkMode ? (
                  ...
                  <a
                    href='https://steamcommunity.com/id/kurotekku/'
                    target='_blank'
                    rel='noreferrer'
                  >
                    {!darkMode ? (

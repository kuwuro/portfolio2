            ...
            <div className="grid lg:grid-cols-5 grid-cols-1 gap-2 w-full h-full">
                <div className="flex gap-4 justify-center items-start col-span-3 lg:overflow-auto">
                    ...
                    <div className="w-full h-full flex flex-col gap-6 justify-between">
                        <div className="fade-right flex flex-col lg:gap-0 gap-2" style={{animationDelay: '0s'}}>
                        ...
                        <div className="w-full flex lg:flex-row flex-col fade-right lg:gap-12 gap-6" style={{animationDelay: '0.2s'}}>
                            ...
                            <div className="w-full h-full fade-right flex flex-col lg:gap-0 gap-2" style={{animationDelay: '0.4s'}}>
                        ...
                        <div className="w-full flex lg:flex-row flex-col fade-right lg:gap-12 gap-6" style={{animationDelay: '0.6s'}}>
                            <div className="w-full h-full flex flex-col lg:gap-0 gap-2">
                            ...
                            <div className="w-full h-full fade-right flex flex-col lg:gap-0 gap-2" style={{animationDelay: '0.8s'}}>
